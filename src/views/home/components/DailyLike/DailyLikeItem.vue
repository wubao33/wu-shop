    ...
    <div class="content">
      <div class="imageWrapper">
        <div class="is-visible">
          <van-image class="image" :src="daily.small_image">
      ...
      <div class="infoWrapper">
        <div class="name">
          <span class="nameText">{{ daily.name }}</span>
        </div>
        ...
        <div class="priceWrapper">
          <div class="priceInfo">
            <div class="pricePart">
              <div class="price">
                {{daily.price|moneyFormat}}
              </div>
              <div class="originPrice">{{ daily.origin_price|moneyFormat }}</div>
            </div>
          </div>
          <div class="iconCartWrapper" @click.stop="addToCart(daily)">
  ...
  methods: {
    addToCart(goods) {
      if (Object.values(this.userInfo).length === 0) {
        ...
        PubSub.publish('sortAddToCart', goods);
      }
    }
  }
}
